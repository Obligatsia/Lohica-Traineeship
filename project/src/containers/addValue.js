...
<div className='form-group'>
    ...
    <input  ref={node => surNameField = node} className = 'form-control' type ='text' placeholder='Smith' id='surname' ></input>
    <div className="invalid-feedback">Only latin letters</div>
    ...
    <input  ref={node => emailField = node} className = 'form-control'type ='text' placeholder='johnsmith@gmail.com' id='email'></input>
    ...
    <input  ref={node => photoField = node} className = 'form-control' type ='file' id='photo'></input>
    ...
    <select  ref={node => genderField = node} className = 'form-control' id='gender'>
<option value = 'male'>Male</option>
    ...
    <input  ref={node => ageField = node} className = 'form-control' type ='number' id='age'  placeholder = '18'></input>
    <div className="invalid-feedback">Please, enter correct age</div>
    </div>

    <div className='form-group'>
        <label htmlFor ='middleName'  >Enter your Middle Name</label>
    <input  ref={node => middleNameField = node} className = 'form-control' type ='text' placeholder='Brown' id='middleName' ></input>
    <div className="invalid-feedback">Only latin letters</div>
